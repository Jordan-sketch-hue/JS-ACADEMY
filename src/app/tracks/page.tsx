  ...
  return (
    <Shell>
      <div className="bg-white border-b border-neutral-100 px-6 py-3.5">
        <div className="text-[13px] text-neutral-500">All tracks · Week 1</div>
      </div>
        ...
        {tracks.map(([track, meta]) => {
          ...
          return (
            <div key={track} className="mb-8">
              ...
              <div className="text-[12px] text-neutral-400 mb-3">{meta.description}</div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex-1 min-w-0">
                        <div className="text-[13px] font-medium text-ink truncate">{course.title}</div>
